...
ActiveRecord::Schema.define(version: 2025_07_24_070721) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["user_id", "bookmarkable_type", "bookmarkable_id"], name: "index_bookmarks_on_user_and_target", unique: true
